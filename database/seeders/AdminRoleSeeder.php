...
class AdminRoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::firstOrCreate(['name' => 'match_body', 'guard_name' => 'admin']);
        Permission::firstOrCreate(['name' => 'match_moung', 'guard_name' => 'admin']);
        Permission::firstOrCreate(['name' => 'odds_body', 'guard_name' => 'admin']);
        Permission::firstOrCreate(['name' => 'odds_moung', 'guard_name' => 'admin']);
        Permission::firstOrCreate(['name' => 'bet', 'guard_name' => 'admin']);
        Permission::firstOrCreate(['name' => 'total_body', 'guard_name' => 'admin']);
        Permission::firstOrCreate(['name' => 'total_body_history', 'guard_name' => 'admin']);
        Permission::firstOrCreate(['name' => 'total_moung', 'guard_name' => 'admin']);
        Permission::firstOrCreate(['name' => 'total_moung_history', 'guard_name' => 'admin']);
        Permission::firstOrCreate(['name' => 'feedback', 'guard_name' => 'admin']);
        Permission::firstOrCreate(['name' => 'ads', 'guard_name' => 'admin']);
        ...
        $role1->givePermissionTo('match_body');
        $role1->givePermissionTo('match_moung');
        $role1->givePermissionTo('odds_body');
        $role1->givePermissionTo('odds_moung');
        $role1->givePermissionTo('total_body');
        $role1->givePermissionTo('total_body_history');
        $role1->givePermissionTo('total_moung');
        $role1->givePermissionTo('total_moung_history');
        $role1->givePermissionTo('feedback');
        $role1->givePermissionTo('ads');
